                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 mb-4">
                        ...
                        <span class="pull-right">
                            <span class="badge indigo">
                                <a href="https://www.facebook.com/sharer.php?u=https://www.recruiteriia.com/openings/{{$open->slug}}" target="_blank" class="share-social">
                                    <i class="fa fa-facebook"></i>
                                </a>
                            </span>
                            <span class="badge badge-danger">
                                <a href="https://plus.google.com/share?url=https://www.recruiteriia.com/openings/{{$open->slug}}" target="_blank" class="share-social">
                                    <i class="fa fa-google-plus"></i>
                                </a>
                            </span>
                            <span class="badge badge-info">
                                <a href="http://www.linkedin.com/shareArticle?mini=true&url=https://www.recruiteriia.com/openings/{{$open->slug}}&title=Opening&summary=" target="_blank" class="share-social">
