$(function() {
    ...
    $(d).on("submit", function(e) {
        ...
        $.ajax({
            ...
            u.removeClass("text-danger"), u.addClass("text-success"), u.text(e), $("#name").val(""), $("#email").val(""), $("#message").val("")
        }).fail(function(e) {
            u.removeClass("text-success"), u.addClass("text-danger"), "" !== e.responseText ? u.text(e.responseText) : u.text("Oops! An error occured and your message could not be sent.")
        })
    })
});