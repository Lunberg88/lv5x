...
'lates_display_mode'              => 'grid',
'category_pzoom'                     => 1,
'quickview'                          => 0,
'show_swap_image'                    => 0,
);
$latestConfig     = array_merge($latestConfig, $themeConfig );
$DISPLAY_MODE 	    = $latestConfig['cateogry_display_mode'];
if($detect->isTablet()) {
...
$MAX_ITEM_ROW       = $themeConfig['listing_products_columns']?6:2;
}
$MAX_ITEM_ROW_SMALL = $latestConfig['listing_products_columns_small']?$latestConfig['listing_products_columns_small']:2;
$MAX_ITEM_ROW_MINI  = $latestConfig['listing_products_columns_minismall']?$latestConfig['listing_products_columns_minismall']:1;
$categoryPzoom 	    = $latestConfig['category_pzoom'];
$quickview          = $latestConfig['quickview'];
$swapimg            = $latestConfig['show_swap_image'];
?>
<?php echo $header; ?>
